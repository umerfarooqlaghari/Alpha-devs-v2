          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="consulting">Software Consultancy</option>
                ...
                <button
                  type="submit"
                  className="w-full bg-black text-white px-8 py-4 rounded-md text-lg font-semibold hover:bg-gray-800 transition-colors shadow-lg"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-black rounded-lg flex items-center justify-center flex-shrink-0 shadow-lg">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">1ST Street<br />PCSIR Labs<br />Karachi</p>
                    </div>
                  </div>

                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-gray-800 rounded-lg flex items-center justify-center flex-shrink-0 shadow-lg">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+92 (300) 9243063</p>
                    </div>
                  </div>

                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-gray-700 rounded-lg flex items-center justify-center flex-shrink-0 shadow-lg">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@alpha-devs.com</p>
                    </div>
                  </div>

                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-gray-600 rounded-lg flex items-center justify-center flex-shrink-0 shadow-lg">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                <h3 className="text-lg font-semibold text-black mb-4">Quick Response</h3>
